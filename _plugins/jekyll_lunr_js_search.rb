...
module Jekyll
  ...
  class Indexer < Generator
    ...
    def generate(site)
      ...
      @site_url = site.config['baseurl'] + site.config['version_url_prefix_apidoc']
      ...
      items.each do |item|
        ...
        if entry.categories[0] === "overview"
          url.prepend(@site_url + "/#")
        elsif entry.categories[0] === nil
          next
        else
          url.prepend(@site_url + "/" + entry.categories[0] + "/#")
        end
